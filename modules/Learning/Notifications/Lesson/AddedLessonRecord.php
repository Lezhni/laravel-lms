 ...
 *
 */
class AddedLessonRecord extends Notification implements ShouldQueue, ShouldBroadcast
{
    use Queueable;
    ...
    public function toArray(mixed $notifiable): array
    {
        ...
        return [
            'message' => "К занятию \"{$this->lesson->name}\" добавлена ссылка на видеозапись",
            'link' => $lessonLink,
        ];
    }
